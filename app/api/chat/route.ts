...
Подробную информацию о мероприятиях вы можете найти на сайте администрации: <a href='https://afisha.yandex.ru/nizhny-novgorod' target='_blank'>Афиша мероприятий</a>`,
...
export async function POST(request: Request) {
  ...
  if (message === 'INITIAL_MESSAGE') {
    return NextResponse.json({
      response: "Здравствуйте! 👋 Я чат-бот Администрации Ленинского района. Я могу помочь вам с информацией о мероприятиях, контактах, услугах и многом другом. Выберите интересующую вас тему или задайте вопрос:",
